...
When you use MotyBase, certain information may be automatically collected, including:

- Device information (such as model, operating system, language).
- App interactions (such as screens viewed, session length).
...
MotyBase uses the following third-party services:
